...
export const profile: Profile = {
  ...
  tagline:
    "Développeuse fullstack passionnée par la création d'applications web élégantes et performantes. Alliant rigueur technique et sensibilité UI/UX, je conçois des solutions numériques sur mesure — du backend robuste aux interfaces fluides.",
};
